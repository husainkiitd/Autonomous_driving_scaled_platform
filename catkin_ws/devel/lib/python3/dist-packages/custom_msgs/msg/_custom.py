...
"""autogenerated by genpy from custom_msgs/custom.msg. Do not edit."""
import codecs
import sys
...
class custom(genpy.Message):
  _md5sum = "df8fc9de899ddde5dfec399a5e112d32"
  _type = "custom_msgs/custom"
...
"""
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.theta = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
