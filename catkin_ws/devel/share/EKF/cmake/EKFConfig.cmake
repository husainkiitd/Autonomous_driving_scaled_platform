...
if("TRUE" STREQUAL "TRUE")
  set(EKF_SOURCE_PREFIX /home/kishor/catkin_ws/src/EKF)
  set(EKF_DEVEL_PREFIX /home/kishor/catkin_ws/devel)
  set(EKF_INSTALL_PREFIX "")
  set(EKF_PREFIX ${EKF_DEVEL_PREFIX})
else()
  set(EKF_SOURCE_PREFIX "")
  set(EKF_DEVEL_PREFIX "")
  set(EKF_INSTALL_PREFIX /home/kishor/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'EKF' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kishor/catkin_ws/src/EKF/${idir}'.  ${_report}")
    endif()
