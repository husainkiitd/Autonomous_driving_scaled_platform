...
WB = 0.30  # rear to front wheel
W = 0.20  # width of car
LF = 0.4  # distance from rear to vehicle front end
LB = 0.10  # distance from rear to vehicle back end
MAX_STEER = 0.5236  # [rad] maximum steering angle
...
def plot_arrow(x, y, yaw, length=0.10, width=0.5, fc="r", ec="k"):
    """Plot arrow."""
