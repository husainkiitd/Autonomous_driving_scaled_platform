...
data = load("racetrackPP12march_ld_0.6.mat");
...
mind =data.out.min_d.signals.values(:,:,1:length(time));
mind = reshape(mind, [], 1);
...
title("Time v/s steering angle PURE PURSUIT")
...
title("Time v/s Cross Track Error PURE PURSUIT")
...
title("Time v/s Yaw Rate PURE PURSUIT")
